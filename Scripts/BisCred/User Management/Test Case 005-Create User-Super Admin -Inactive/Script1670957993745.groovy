...
WebUI.uncheck(findTestObject('User Management/Create User Elements/Activted Checkbox'))
...
WebUI.verifyElementText(findTestObject('User Management/Users list/Inactive label'), 'Inactive')
